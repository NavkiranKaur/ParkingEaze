...
public class AfterLoginScreen extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener {
   ...
   // }
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == R.id.logout) {
            ...
            Intent i = new Intent(AfterLoginScreen.this, MainActivity.class);
